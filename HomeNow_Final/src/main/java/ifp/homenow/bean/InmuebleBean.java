...
public class InmuebleBean {
	...
	public InmuebleBean(long idinmuebles, String tipo, int precio_inmueble, int superficie,
			DireccionBean direccion_inmueble, int habitacion, int bano, String imagen_inmueble,
			String descripcion_inmueble, UsuarioBean usuarios_inmueble) {
		super();
