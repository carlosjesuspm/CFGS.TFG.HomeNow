		...
		<section class="">
			<div class="container text-center text-md-start mt-5">
				...
				<div class="row mt-3">
					<!-- Grid column -->
					<div
						class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4 pt-3 text-center">
						<!-- Content -->
						<h6 class="text-uppercase fw-bold mb-4">
							<i class="fas fa-gem me-3 text-secondary"></i>HomeNow
						</h6>
						<p>Bienvenido a nuestro portal inmobiliario, donde los jóvenes
							encuentran las oportunidades que buscan</p>
					</div>

					<!-- Grid column -->
					<div
						class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4 pt-3 text-center">
						<!-- Links -->
						<h6 class="text-uppercase fw-bold mb-4">LINKS PRINCIPALES</h6>
						<p>
					...
					<!-- Grid column -->
					<div
						class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4 pt-3 text-center">
						<!-- Links -->
						<h6 class="text-uppercase fw-bold mb-4">CONTACTO</h6>
						<p>
							<i class="fas fa-home me-3 text-secondary"></i> Madrid, España
						</p>
						<p>
